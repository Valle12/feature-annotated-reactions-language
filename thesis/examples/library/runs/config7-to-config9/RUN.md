...
| dirty rules | 30 (27 added, 3 removed) |
| dirty rules whose trigger matches a source element | 12 |
...
+ umlToJavaClassifier::UmlInterfaceRealizationCreatedAddSuffix  matches 0 source element(s)
