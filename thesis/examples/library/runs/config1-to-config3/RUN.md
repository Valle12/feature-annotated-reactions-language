...
| dirty rules | 9 (9 added, 0 removed) |
...
The migrated models hold exactly what `baselines/config3` holds, listed in a different order. Nothing is missing, added or derived differently; a classifier's members simply came back in the order the repropagation rebuilt them in rather than the order a derivation from scratch produces.
