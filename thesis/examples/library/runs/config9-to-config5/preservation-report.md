...
- references::MethodCall in Member.totalWeight.Block at src/catalog/Member.java#0/@classifiers.0/@members.11/@statements.1/@statement/@statements.0/@expression/@value/@next.target
  the new rules produce a different value: pathmap:/javaclass/catalog.MediaImpl.java#//@classifiers.0/@members.12 is now src/catalog/MediaImpl.java#//@classifiers.0/@members.12
- references::IdentifierReference in LibraryCard.setCardNumber at src/catalog/LibraryCard.java#0/@classifiers.0/@members.3/@statements.0/@expression/@child.target
