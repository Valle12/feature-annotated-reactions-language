...
Left to deal with by hand: 45 (38 would be kept + 5 not kept + 2 open decisions)
...
- members::ClassMethod 'getTitle' in MediaImpl at src/catalog/MediaImpl.java#0/@classifiers.0/@members.2
  into classifiers::Interface 'MediaImpl' at src/catalog/MediaImpl.java#0/@classifiers.0 (members)
- members::ClassMethod 'setTitle' in MediaImpl at src/catalog/MediaImpl.java#0/@classifiers.0/@members.3
  into classifiers::Interface 'MediaImpl' at src/catalog/MediaImpl.java#0/@classifiers.0 (members)
- members::ClassMethod 'getMediaId' in MediaImpl at src/catalog/MediaImpl.java#0/@classifiers.0/@members.5
  into classifiers::Interface 'MediaImpl' at src/catalog/MediaImpl.java#0/@classifiers.0 (members)
- members::ClassMethod 'setMediaId' in MediaImpl at src/catalog/MediaImpl.java#0/@classifiers.0/@members.6
  into classifiers::Interface 'MediaImpl' at src/catalog/MediaImpl.java#0/@classifiers.0 (members)
- members::ClassMethod 'getType' in MediaImpl at src/catalog/MediaImpl.java#0/@classifiers.0/@members.8
  into classifiers::Interface 'MediaImpl' at src/catalog/MediaImpl.java#0/@classifiers.0 (members)
- members::ClassMethod 'setType' in MediaImpl at src/catalog/MediaImpl.java#0/@classifiers.0/@members.9
  into classifiers::Interface 'MediaImpl' at src/catalog/MediaImpl.java#0/@classifiers.0 (members)
- members::ClassMethod 'getWeight' in MediaImpl at src/catalog/MediaImpl.java#0/@classifiers.0/@members.11
  into classifiers::Interface 'MediaImpl' at src/catalog/MediaImpl.java#0/@classifiers.0 (members)
- members::ClassMethod 'setWeight' in MediaImpl at src/catalog/MediaImpl.java#0/@classifiers.0/@members.12
  into classifiers::Interface 'MediaImpl' at src/catalog/MediaImpl.java#0/@classifiers.0 (members)
- modifiers::Abstract in MediaImpl at src/catalog/MediaImpl.java#0/@classifiers.0/@annotationsAndModifiers.1
  into classifiers::Interface 'MediaImpl' at src/catalog/MediaImpl.java#0/@classifiers.0 (annotationsAndModifiers)
...
- modifiers::Private in Book.pageCount at src/catalog/Book.java#0/@classifiers.0/@members.4/@annotationsAndModifiers.0
...
- modifiers::Private in LibraryCard.cardNumber at src/catalog/LibraryCard.java#0/@classifiers.0/@members.1/@annotationsAndModifiers.0
...
- modifiers::Private in MediaImpl.title at src/catalog/MediaImpl.java#0/@classifiers.0/@members.1/@annotationsAndModifiers.0
  into members::Field 'title' in MediaImpl at src/catalog/MediaImpl.java#0/@classifiers.0/@members.0 (annotationsAndModifiers)
- modifiers::Private in MediaImpl.mediaId at src/catalog/MediaImpl.java#0/@classifiers.0/@members.4/@annotationsAndModifiers.0
  into members::Field 'mediaId' in MediaImpl at src/catalog/MediaImpl.java#0/@classifiers.0/@members.1 (annotationsAndModifiers)
- modifiers::Private in MediaImpl.type at src/catalog/MediaImpl.java#0/@classifiers.0/@members.7/@annotationsAndModifiers.0
  into members::Field 'type' in MediaImpl at src/catalog/MediaImpl.java#0/@classifiers.0/@members.2 (annotationsAndModifiers)
- modifiers::Private in MediaImpl.weight at src/catalog/MediaImpl.java#0/@classifiers.0/@members.10/@annotationsAndModifiers.0
  into members::Field 'weight' in MediaImpl at src/catalog/MediaImpl.java#0/@classifiers.0/@members.3 (annotationsAndModifiers)
- modifiers::Private in Member.name at src/catalog/Member.java#0/@classifiers.0/@members.1/@annotationsAndModifiers.0
  into members::Field 'name' in Member at src/catalog/Member.java#0/@classifiers.0/@members.0 (annotationsAndModifiers)
- modifiers::Private in Member.active at src/catalog/Member.java#0/@classifiers.0/@members.4/@annotationsAndModifiers.0
  into members::Field 'active' in Member at src/catalog/Member.java#0/@classifiers.0/@members.1 (annotationsAndModifiers)
- modifiers::Private in Member.borrowed at src/catalog/Member.java#0/@classifiers.0/@members.7/@annotationsAndModifiers.0
...
- modifiers::Final in Member.register at src/catalog/Member.java#0/@classifiers.0/@members.10/@annotationsAndModifiers.2
  into members::InterfaceMethod 'register' in Member at src/catalog/Member.java#0/@classifiers.0/@members.3 (annotationsAndModifiers)
...
- imports::ClassifierImport at src/catalog/MediaImpl.java#0/@imports.0
  several migrated elements could be the same one and nobody chose: it could be [imports::ClassifierImport at src/catalog/MediaImpl.java#0/@imports.0]
- types::NamespaceClassifierReference in MediaImpl at src/catalog/MediaImpl.java#0/@classifiers.0/@implements.0
...
- Which migrated element continues imports::ClassifierImport at src/catalog/MediaImpl.java#0/@imports.0?
  nobody could decide: imports::ClassifierImport at src/catalog/MediaImpl.java#0/@imports.0
- Which feature of classifiers::Interface should hold types::NamespaceClassifierReference in MediaImpl at src/catalog/MediaImpl.java#0/@classifiers.0/@implements.0?
