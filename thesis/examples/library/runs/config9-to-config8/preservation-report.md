...
- modifiers::Abstract in MediaImpl at src/catalog/MediaImpl.java#0/@classifiers.0/@annotationsAndModifiers.1
  into classifiers::Enumeration 'MediaImpl' at src/catalog/MediaImpl.java#0/@classifiers.0 (annotationsAndModifiers)
- types::NamespaceClassifierReference in MediaImpl at src/catalog/MediaImpl.java#0/@classifiers.0/@implements.0
  into classifiers::Enumeration 'MediaImpl' at src/catalog/MediaImpl.java#0/@classifiers.0 (implements)
- types::ClassifierReference in MediaImpl at src/catalog/MediaImpl.java#0/@classifiers.0/@defaultExtends
  into classifiers::Enumeration 'MediaImpl' at src/catalog/MediaImpl.java#0/@classifiers.0 (implements)
...
- modifiers::Static in LibraryCard.getCardNumber at src/catalog/LibraryCard.java#0/@classifiers.0/@members.2/@annotationsAndModifiers.1
...
- modifiers::Static in LibraryCard.setCardNumber at src/catalog/LibraryCard.java#0/@classifiers.0/@members.3/@annotationsAndModifiers.1
...
- statements::Return in Member.totalWeight at src/catalog/Member.java#0/@classifiers.0/@members.11/@statements.2
  into members::ClassMethod 'totalWeight' in Member at src/catalog/Member.java#0/@classifiers.0/@members.10 (statements)
- references::IdentifierReference in LibraryCard.setCardNumber at src/catalog/LibraryCard.java#0/@classifiers.0/@members.3/@statements.0/@expression/@child/@next
...
- references::IdentifierReference in LibraryCard.setCardNumber at src/catalog/LibraryCard.java#0/@classifiers.0/@members.3/@statements.0/@expression/@child.target
...
- references::IdentifierReference in LibraryCard.getCardNumber at src/catalog/LibraryCard.java#0/@classifiers.0/@members.2/@statements.0/@returnValue
...
- references::IdentifierReference in LibraryCard.setCardNumber at src/catalog/LibraryCard.java#0/@classifiers.0/@members.3/@statements.0/@expression/@value
