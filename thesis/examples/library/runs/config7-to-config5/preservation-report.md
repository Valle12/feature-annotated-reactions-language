...
Left to deal with by hand: 33 (33 would be kept + 0 not kept + 0 open decisions)
...
- literals::NullLiteral in Media.title at src/catalog/Media.java#0/@classifiers.0/@members.0/@initialValue
  into members::Field 'title' in Media at src/catalog/Media.java#0/@classifiers.0/@members.1 (initialValue)
...
- literals::DecimalIntegerLiteral in Media.mediaId at src/catalog/Media.java#0/@classifiers.0/@members.1/@initialValue
  into members::Field 'mediaId' in Media at src/catalog/Media.java#0/@classifiers.0/@members.4 (initialValue)
...
- literals::NullLiteral in Media.type at src/catalog/Media.java#0/@classifiers.0/@members.2/@initialValue
  into members::Field 'type' in Media at src/catalog/Media.java#0/@classifiers.0/@members.7 (initialValue)
...
- literals::DecimalDoubleLiteral in Media.weight at src/catalog/Media.java#0/@classifiers.0/@members.3/@initialValue
  into members::Field 'weight' in Media at src/catalog/Media.java#0/@classifiers.0/@members.10 (initialValue)
